...
class Snake:
    ...
    def reset(self):
        ...
        clears the segment's list of previous items, then creates a new snake in
    ...
    def move(self):
        ...
        # we move the last segment to second to last make a loop for it.
        # the range is start = length of a segment list, stop is 0 and not included that is 1st
